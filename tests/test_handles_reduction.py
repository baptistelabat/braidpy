from src.braidpy.handles_reduction import dehornoy_reduce_core
...
def test_dehornoy_reduce_core():
    ...
    reduced, _ =dehornoy_reduce_core(gens= [1,2,1,-3,-2,-3,-1,-2,-1,3,2,3,1]) # Example from "Le calcul des tresses 1.2.3 page 164
