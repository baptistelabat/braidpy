...
def test_dehornoy_reduce_core():
    ...
    reduced, sign =dehornoy_reduce_core(gens= [1]) # Example from "Le calcul des tresses 1.2.3 page 164
    assert reduced == [1]
    assert sign==1
    ...
    reduced, sign =dehornoy_reduce_core(gens= [-2, -2 , -1, -1, 2, 2, 1, 1]) # Example from "Le calcul des tresses 1.2.3 page 164
    assert reduced == [-2, 1, -2, 1, -2, 1]
    assert sign==1

    reduced, sign =dehornoy_reduce_core(gens= [-2, -2 , -1, -1, 2, 2, 1, 1], mode=HandleReductionMode.COMPARE) # Example from "Le calcul des tresses 1.2.3 page 164
    assert sign==1
